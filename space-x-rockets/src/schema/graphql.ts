...
export type RocketDetailsQueryQueryVariables = Exact<{
  rocketId: Scalars['ID']['input'];
}>;


export type RocketDetailsQueryQuery = { __typename?: 'Query', rocket?: { __typename?: 'Rocket', active?: boolean | null, boosters?: number | null, company?: string | null, cost_per_launch?: number | null, country?: string | null, description?: string | null, id?: string | null, name?: string | null, diameter?: { __typename?: 'Distance', feet?: number | null, meters?: number | null } | null, height?: { __typename?: 'Distance', feet?: number | null, meters?: number | null } | null, mass?: { __typename?: 'Mass', kg?: number | null, lb?: number | null } | null } | null };


export const RocketDetailsQueryDocument = gql`
...
/**
 * __useRocketDetailsQueryQuery__
 *
 * To run a query within a React component, call `useRocketDetailsQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useRocketDetailsQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRocketDetailsQueryQuery({
 *   variables: {
 *      rocketId: // value for 'rocketId'
 *   },
 * });
 */
export function useRocketDetailsQueryQuery(baseOptions: Apollo.QueryHookOptions<RocketDetailsQueryQuery, RocketDetailsQueryQueryVariables> & ({ variables: RocketDetailsQueryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RocketDetailsQueryQuery, RocketDetailsQueryQueryVariables>(RocketDetailsQueryDocument, options);
      }
export function useRocketDetailsQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RocketDetailsQueryQuery, RocketDetailsQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RocketDetailsQueryQuery, RocketDetailsQueryQueryVariables>(RocketDetailsQueryDocument, options);
        }
export function useRocketDetailsQuerySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<RocketDetailsQueryQuery, RocketDetailsQueryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<RocketDetailsQueryQuery, RocketDetailsQueryQueryVariables>(RocketDetailsQueryDocument, options);
        }
export type RocketDetailsQueryQueryHookResult = ReturnType<typeof useRocketDetailsQueryQuery>;
export type RocketDetailsQueryLazyQueryHookResult = ReturnType<typeof useRocketDetailsQueryLazyQuery>;
export type RocketDetailsQuerySuspenseQueryHookResult = ReturnType<typeof useRocketDetailsQuerySuspenseQuery>;
export type RocketDetailsQueryQueryResult = Apollo.QueryResult<RocketDetailsQueryQuery, RocketDetailsQueryQueryVariables>;